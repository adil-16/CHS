...
public class managerComponents extends javax.swing.JFrame {

    /**
     * Creates new form managerComponents
     */
    public managerComponents() {
        initComponents();
        jPanel3.hide();
        jLabel10.hide();
        Components.show();
    ...
    private void initComponents() {
        ...
        Components.setFont(new java.awt.Font("Agency FB", 1, 28)); // NOI18N
        ...
        jPanel3.add(Show, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 310, -1, -1));
        ...
        jPanel3.add(Add, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 310, -1, -1));
        ...
        jPanel3.add(Delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, -1, -1));
        ...
        jPanel3.add(Update22, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 310, -1, -1));
        ...
        jPanel3.add(Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 310, -1, -1));
        ...
        jPanel3.add(tips, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 310, -1, -1));
        ...
        jPanel3.add(JCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 200, -1, -1));
        ...
        jPanel3.add(Delete1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 270, -1, -1));
        ...
        jPanel3.add(Update1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 270, -1, -1));

        jComboBox1.setBackground(new java.awt.Color(0, 51, 51));
        jComboBox1.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Components" }));
        jComboBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox1ActionPerformed(evt);
            }
        });
        jPanel3.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 180, -1));

        jsize.setText("Size (if any)");
        jPanel3.add(jsize, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 130, -1, -1));

        size.setText("e.g. 1Gb");
        jPanel3.add(size, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 160, 180, -1));

        jtype.setText("Type (if any)");
        jPanel3.add(jtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, -1, -1));

        type.setText("e.g. DDR4");
        jPanel3.add(type, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 170, -1));

        jLabel3.setText("Shop");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 200, -1, -1));
        ...
        jPanel3.add(jComboBoxShop, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 230, 180, -1));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 420, 360));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 1060));
    ...
    private void Update1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Update1ActionPerformed
        try{
            ...
            if(update_category.equals("Components")){
    ...
    private void AddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddMouseClicked
        try {
            ...
            if(!type.getText().equals("e.g. DDR4") && !size.getText().equals("e.g. 1Gb") ){
    ...
    private void ShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ShowActionPerformed
        try {
            ...
            ResultSet result2 = stmt.executeQuery("select count(*) from product where product_category='Components'");
            employeeCounter.setVisible(true);
            ...
            ResultSet result3 = stmt.executeQuery("select product_name,product_price from product where product_price in (select max(product_price) from product where product_category='Components')");
            HighestSalaryCounter.setVisible(true);
            ...
            ResultSet result4 = stmt.executeQuery("select product_name,product_price from product where product_price in (select min(product_price) from product where product_category='Components')");
            LowestSalaryCounter.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(managerComponents.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
