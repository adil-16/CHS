...
public class managerProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 260, 600));
        ...
        jPanel3.add(Show, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 500, -1, -1));
        ...
        jPanel3.add(Add, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 500, -1, -1));
        ...
        jPanel3.add(Delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 500, -1, -1));
        ...
        jPanel3.add(Update22, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 500, -1, -1));
        ...
        jPanel3.add(Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 500, -1, -1));
        ...
        jPanel3.add(tips, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 500, -1, -1));
        ...
        jPanel3.add(JCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 400, -1, -1));
        ...
        jPanel3.add(Delete1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 460, -1, -1));
        ...
        jPanel3.add(Update1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 460, -1, -1));

        jComboBox1.setBackground(new java.awt.Color(0, 51, 51));
        jComboBox1.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Product", "Accessories", "Components", "Computer" }));
        jComboBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox1ActionPerformed(evt);
            }
        });
        jPanel3.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 420, 180, -1));

        jdevicetype.setText("Device Type (if any)");
        jPanel3.add(jdevicetype, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, -1, -1));
        ...
        jPanel3.add(devicetype, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 120, -1));

        jprocessor.setText("Processor (if any)");
        jPanel3.add(jprocessor, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 160, -1, -1));

        processor.setText("e.g. 3.0 GHz");
        jPanel3.add(processor, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 180, 100, -1));

        jgeneration.setText("Generation (if any)");
        jPanel3.add(jgeneration, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 160, -1, -1));

        generation.setText("e.g. 7");
        jPanel3.add(generation, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 180, 120, -1));

        jsize.setText("Size (if any)");
        jPanel3.add(jsize, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 240, -1, -1));

        size.setText("e.g. 1Gb");
        jPanel3.add(size, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 260, 180, -1));

        jtype.setText("Type (if any)");
        jPanel3.add(jtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, -1, -1));

        type.setText("e.g. DDR4");
        jPanel3.add(type, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 170, -1));

        jmodel.setText("Model (if any)");
        jPanel3.add(jmodel, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 340, -1, -1));

        modell.setText("e.g. 6 series");
        jPanel3.add(modell, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 360, 180, -1));

        jcolor.setText("Color (if any)");
        jPanel3.add(jcolor, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 340, -1, -1));

        color.setText("e.g. Black");
        jPanel3.add(color, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 360, 170, -1));

        jLabel7.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        jLabel7.setText("-------Accessory-------");
        jPanel3.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 300, -1, -1));

        jLabel11.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        jLabel11.setText("-------Computer-------");
        jPanel3.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 130, -1, -1));

        jLabel12.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        jLabel12.setText("-------Component-------");
        jPanel3.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 210, -1, -1));

        jLabel3.setText("Shop");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 400, -1, -1));
        ...
        jPanel3.add(jComboBoxShop, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 420, 180, -1));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 420, 530));
    ...
    private void AddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddMouseClicked
        try {
            ...
            salary = Integer.parseInt(Price.getText());
                ...
                if(!devicetype.getText().equals("e.g Desktop") && !generation.getText().equals("e.g. 7") && !processor.getText().equals("e.g. 3.0 GHz") && type.getText().equals("e.g. DDR4") && size.getText().equals("e.g. 1Gb") && color.getText().equals("e.g. Black") && modell.getText().equals("e.g. 6 series")){
                ...
                else if(!type.getText().equals("e.g. DDR4") && !size.getText().equals("e.g. 1Gb") && devicetype.getText().equals("e.g Desktop") && generation.getText().equals("e.g. 7") && processor.getText().equals("e.g. 3.0 GHz") && color.getText().equals("e.g. Black") && modell.getText().equals("e.g. 6 series")){
                    stmt.executeUpdate("Insert into product values('"+productId+"', '" + jComboBox1.getSelectedItem() + "', '" + salary + "', '" + name + "', '" + quantity.getText() + "')");
                    stmt.executeUpdate("Insert into components values('"+productId+"', '" + size.getText() + "', '" + type.getText() + "')");
                    if(brandfound==false){
                        stmt.executeUpdate("Insert into brand_manufacturer values('"+brandId+"','"+brand.getText()+"','"+year.getText()+"')");
                    }
                    stmt.executeUpdate("Insert into manufactures values('"+brandId+"','"+productId+"')");
                ...
                else if(!color.getText().equals("e.g. Black") && !modell.getText().equals("e.g. 6 series") && devicetype.getText().equals("e.g Desktop") && generation.getText().equals("e.g. 7") && processor.getText().equals("e.g. 3.0 GHz") && type.getText().equals("e.g. DDR4") && size.getText().equals("e.g. 1Gb")){
                    stmt.executeUpdate("Insert into product values('"+productId+"', '" + jComboBox1.getSelectedItem() + "', '" + salary + "', '" + name + "', '" + quantity.getText() + "')");
    ...
    private void Update22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Update22ActionPerformed
        try{
            ...
            if(update_category.equals("Computer")){
                ResultSet computerResult = stmt.executeQuery("select generation, processor, device_type from computer where product_id="+id+"");
                while (computerResult.next()) {
                    generation.setText(computerResult.getString(1));
                    processor.setText(computerResult.getString(2));
                    devicetype.setText(computerResult.getString(3));
                }
                modell.setEnabled(false);
                color.setEnabled(false);
                type.setEnabled(false);
                size.setEnabled(false);
            }
            else if(update_category.equals("Components")){
                ResultSet componentResult = stmt.executeQuery("select size, type from components where product_id="+id+"");
                while (componentResult.next()) {
                   size.setText(componentResult.getString(1));
                   type.setText(componentResult.getString(2));   
                }
                modell.setEnabled(false);
                color.setEnabled(false);
            ...
            else if(update_category.equals("Accessories")){
            ...
            if(count==0){
                ...
                jdevicetype.setText("New Device Type");
                jprocessor.setText("New Processor");
                jgeneration.setText("New Generation");
                jtype.setText("New Type");
                jsize.setText("New Size");
    ...
    private void Update1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Update1ActionPerformed
        try{
            ...
            if(update_category.equals("Computer")){
                 stmt.executeUpdate("update computer set device_type = '"+devicetype.getText()+"' where product_id="+oldNaming+"");
                 stmt.executeUpdate("update computer set processor = '"+processor.getText()+"' where product_id="+oldNaming+"");
                 stmt.executeUpdate("update computer set generation = '"+generation.getText()+"' where product_id="+oldNaming+"");
            }
            else if(update_category.equals("Components")){
                stmt.executeUpdate("update components set size = '"+size.getText()+"' where product_id="+oldNaming+"");
                stmt.executeUpdate("update components set type = '"+type.getText()+"' where product_id="+oldNaming+"");  
            }
            else if(update_category.equals("Accessories")){
        ...
        jdevicetype.setText("Device Type");
        jprocessor.setText("Processor");
        jgeneration.setText("Generation");
        jtype.setText("Type");
        jsize.setText("Size");
