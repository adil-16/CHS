...
public class managerComputer extends javax.swing.JFrame {

    /**
     * Creates new form managerComputer
     */
    ...
    private void initComponents() {
        ...
        Computer.setFont(new java.awt.Font("Agency FB", 1, 28)); // NOI18N
        ...
        jPanel3.add(Show, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 330, -1, -1));
        ...
        jPanel3.add(Add, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 330, -1, -1));
        ...
        jPanel3.add(Delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 330, -1, -1));
        ...
        jPanel3.add(Update22, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 330, -1, -1));
        ...
        jPanel3.add(Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 330, -1, -1));
        ...
        jPanel3.add(tips, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 330, -1, -1));
        ...
        jPanel3.add(JCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 230, -1, -1));
        ...
        jPanel3.add(Delete1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 290, -1, -1));
        ...
        jPanel3.add(Update1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 290, -1, -1));
        ...
        jPanel3.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 180, -1));
        ...
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 230, -1, -1));
        ...
        jPanel3.add(jComboBoxShop, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 180, -1));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 420, 380));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, -1, 1060));
    ...
    private void ShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ShowActionPerformed
        try {
            ...
            ResultSet result2 = stmt.executeQuery("select count(*) from product where product_category='Computer'");
            employeeCounter.setVisible(true);
            ...
            ResultSet result3 = stmt.executeQuery("select product_name,product_price from product where product_price in (select max(product_price) from product where product_category='Computer')");
            HighestSalaryCounter.setVisible(true);
            ...
            ResultSet result4 = stmt.executeQuery("select product_name,product_price from product where product_price in (select min(product_price) from product where product_category='Computer')");
            LowestSalaryCounter.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(managerComputer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
